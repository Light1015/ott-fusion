...
const Footer: React.FC = () => {
  return (
    <footer className="border-t border-border py-8 px-4 md:px-12 mt-8">
      <div className="container mx-auto">
        ...
        <p className="text-center text-sm text-muted-foreground">© 2024 StreamiX. All rights reserved.</p>
      </div>
    </footer>
  );
};
